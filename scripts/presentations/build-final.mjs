...
// 5. Every architecture stage is editable text within a native table.
{
 ...
 table(s,[['Layer','Databricks component','What the run records'],['Ingestion','Serverless Lakeflow Job','Official responses and checksums'],['Bronze / Silver','Delta tables in Unity Catalog','Raw archive, typed rows, quarantine'],['Gold','Published snapshot and SQL views','Access model, allocations, audit'],['Evaluation','MLflow experiment','Parameters and baseline comparisons'],['Application','Databricks App + SQL warehouse','Platform sign-in and saved proposals']],60,150,1160,340,[220,400,540],23);
 text(s,readiness,60,527,1130,49,32,cloud?C.ink:C.orange,true);
 text(s,cloud?'Evidence links and execution mode appear in the speaker notes.':'Local execution verified. Cloud run evidence remains the next gate.',60,586,1150,40,24,C.muted);
